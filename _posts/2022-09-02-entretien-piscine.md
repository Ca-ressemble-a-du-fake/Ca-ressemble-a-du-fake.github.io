...
Au début, mon savoir sur le fonctionnement d'une piscine était extrêmement maigre. Et, ce que je lisais dans le manuel d'entretien de la **piscine au sel**, ou sur certains forums, allait complètement à l'encontre de mes convictions environnementales. 
...
###### À cause de l'entretien du filtre à sable
...
2. Ne pas vider l'eau pour l'hiver (hivernage actif) : vider l'eau qu'on a eu tant de mal à conserver tout l'été serait un crève-cœur pour moi (hivernage passif) 😭. Ma méthode consiste donc à garder l'eau et aussi à laisser allumé l'électro-chlorateur le plus longtemps possible. Les différentes pluies vont faire remonter le niveau d'eau, et cette eau plutôt acide va se mélanger avec l'eau chlorée du bassin, ce qui aura tendance à refaire baisser le pH. Des contrôles visuels et avec les bandelettes sont effectués régulièrement, afin de connaître le taux de chlore, et de s'assurer de l'absence d'algues. Dans le cas où des algues seraient présentes, un galet de chlore lent serait placés dans le panier de l'écumeur de surface. Quand les pluies sont trop abondantes, si le niveau d'eau dans le bassin est trop élevé, un lavage à contre-courant est réalisé. Là encore l'économie d'eau est énorme puisqu'on évite à la sortie de l'hiver de remettre l'eau qu'on a enlevée pour l'hivernage. Donc dans notre cas, ça fait encore 8 $$m^3$$ d'économisés. Pas de contrainte, puisqu'on n'a rien à faire 😎.
  ...
  💡Note : dans une piscine au sel, ne pas vider l’eau permet aussi de conserver le sel, et donc d’avoir à rajouter moins de sel en sortie d’hivernage.

3. Utiliser des filtres de "nettoyage de printemps" pour son robot de piscine électrique [voir article sur ce sujet]({% post_url 2022-09-03-filtre-de-printemps %})  : cette simple astuce-là permet d'éviter de passer l'aspirateur dans le bassin, d'encrasser le filtre à sable et donc de devoir le laver à contre-courant. L'été 2022 est la première saison où j'utilise ces filtres, et bien que la sécheresse ait fait tomber les feuilles des arbres en plein été, je n'ai pas eu besoin d'effectuer le moindre lavage à contre-courant. Ces nouveaux filtres ont été passés plusieurs fois, donc sur toute la saison c'est une économie de 1,3 $$m^3$$ d'eau. Niveau contrainte là encore, il n'y en a pas, puisque le robot travaille à notre place! 

> Cette année, j'ai découvert ces filtres seulement APRÈS avoir passé le balais aspirateur en sortie d'hivernage. Il m'a donc fallu réaliser plusieurs copieux lavages à contre-courant. L'eau qui a été perdue à ce moment-là a manqué en fin de saison (cf niveau d'eau trop bas pour utiliser l'écumeur de surface). L'an prochain, je ne m'en tiendrai qu'au robot avec filtres de "nettoyage de printemps" pour garder un maximum d'eau dans la piscine.


##### Bilan des économies

Récapitulons l'impact de ces nouvelles habitudes sur ma consommation d'eau. On indique aussi les contraintes que cela ajoute.


---

|-------|-------|------|
| Action --- | Impact sur l'environnement --- | Contrainte |
|-------|--------|---------|
| Baigneurs propres / Combinaison anti-UV | Eau reste claire et ne pique pas sans utilisation de produits chimiques  | Légère$$^*$$ |
| Bassin découvert seulement lors des baignades | 33 $$m^3$$ d'eau économisés | Forte |
| Pas de vidange pour l'hiver | 8 $$m^3$$ d'eau économisés | Aucune |
| Filtre de nettoyage de nettoyage de printemps | 1,3 $$m^3$$ d'eau économisés | Aucune |
|-------|-------|------|  
{:.table-striped}

---

$$^*$$ sauf si on est nudiste pur-et-dur ET qu'on veut devenir couleur caramel en se baignant aux heures de plus fort ensoleillement (déconseillé car risque de cancer de la peau).

On voit donc que ces simples actions permettent d'économiser chaque année 42 $$m^3$$ d'eau (soit presque un bassin complet). Bâcher sa piscine après chaque baignade a le plus fort impact, même s'il implique une réelle action physique "militante" de la part de la personne qui débâche (le rebâchage est pour sa part peu contraignant, car il suffit de tirer sur une corde)! 

💡Alternative : pour les personnes qui ne se sentent pas de découvrir à la manivelle le bassin lors de chaque baignade, il existe des dispositifs motorisés que l'on peut ajouter après-coup. C'est beaucoup moins rapide, mais c'est sans effort! Un internaute a posté une vidéo du fonctionnement d'un tel dispositif lors de l'ouverture de la piscine.
    
<iframe width="912" height="513" src="https://www.youtube.com/embed/XsPIe6wCerI" title="Motorisation Bâche à barres" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
